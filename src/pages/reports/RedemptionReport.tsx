...
export default function RedemptionReport() {
  ...
  const { data, isLoading, isSuccess } = useQuery<{
    ...
    queryKey: ["redemptionReport", page, from_date, to_date],
    queryFn: async () => {
      ...
      const res = await allocateApi.getRedemptionReport(
        page,
        from_date,
        addOneDay
      );
  ...
  return (
    <div>
      <PageHeader title="Redemption Report" />
      ...
      <div className="flex justify-between items-center">
        ...
        <Button
          ...
          onClick={() => downloadExcel("redemptionReport", "Allocation Report")}
        >
          Export as Excel
        </Button>
      </div>
                ...
                <Table id="redemptionReport">
                  <TableHead>
                    <TableRow>
                      ...
                      <StyledTableCell>Redeem Date</StyledTableCell>
